# intended for import to change channel of TCA9548A's
# import i2c_mux then call i2c_mux.set_chan(multiplexer_addr,multiplexer_channel)
# example call i2c_mux.set_chan(i2c_mux.RIGHT_MUX,7) to set multiplexer 0x70 to channel 7
